...
namespace GOAP {
    ...
    public abstract class GOAPAction {
        ...
        protected StateDrivenBrain.GOAPStates moveToState;
        public StateDrivenBrain.GOAPStates MoveToState { get { return moveToState; } }
        public GOAPAction(string name, int cost, StateDrivenBrain.GOAPStates moveToState) {
            this.name = name;
