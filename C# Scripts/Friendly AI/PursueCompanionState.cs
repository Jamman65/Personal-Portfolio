...
namespace JO
{
    public class PursueCompanionState : State
    {
        public CombatCompanionState combatState;
        public IdleCompanionState idleState;
        public RotateTowardsTargetCompanionState RotateTowardsTargetState;
        public FollowCompanionState followHostState;

        private void Awake()
        {
            combatState = GetComponent<CombatCompanionState>();
            idleState = GetComponent<IdleCompanionState>();
            RotateTowardsTargetState = GetComponent<RotateTowardsTargetCompanionState>();
